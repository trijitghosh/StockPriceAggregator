...
public class DefaultSubscriber implements Subscriber {
    ...
    public void init(Properties properties, StreamsBuilder builder) {
        ...
        //keySpecificAvroSerde.configure(keySpecificAvroSerde, true);
        valueSpecificAvroSerde.configure(serdeConfig, false);
    }

    public KStream<String, Stock> subscribe() {

        return this.builder.stream(this.properties.getProperty("in-topic"),
                Consumed.with(keySpecificAvroSerde,
